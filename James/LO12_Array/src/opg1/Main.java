...
public class Main {
		...
		public static void main(String[] args) {
				...
				int random[] = { 2, 44, -23, 99, 8, -5, 7, 10, 20, 30 }; // Printer tilfældig
				...
				int[] gange = new int[10]; // Her sætter man et array på længden 10
				for (int i = 0; i < gange.length; i++) { // Kører array loop igennem
						gange[i] = i * 1;
				}
				...
				int[] gangeTo = new int[11]; // Sætter Array længden til 11
				...
				int[] pow = new int[10]; // Sætter Array til 11
				for (int i = 0; i < pow.length; i++) {
						pow[i] = (int) Math.pow(i, 2); // Sætter i til anden..
				}
