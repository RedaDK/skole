...
public class ArrayTest {
		...
		public static void main(String[] args) {
				// Lægger tal sammen i et Array, på hele tal
				int[] arr = { 2, 7, 5, 9, 6, };
				...
				System.out.println("*******************************");
				// Lægger tal sammen i et Array, på decimal tal
		...
		// Metode til at lægge hele tal sammen i array kaldet sum
		...
		// Metode til at lægge decimal tal sammen i array kaldet sumDouble
